...
export function registerItemsHandlers(): void {
  ...
  ipcMain.handle(IPC_CHANNELS.ITEMS_DELETE, (_event, id: string) => itemRepository.softDelete(id))
  ipcMain.handle(IPC_CHANNELS.ITEMS_RESTORE, (_event, id: string) => itemRepository.restore(id))
}

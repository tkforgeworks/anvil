...
export function registerClassesHandlers(): void {
  safeHandle(IPC_CHANNELS.CLASSES_LIST, (_event, options?: { includeDeleted?: boolean; deletedOnly?: boolean }) =>
    classRepository.list(options?.includeDeleted ?? false, options?.deletedOnly ?? false),
  )

  safeHandle(IPC_CHANNELS.CLASSES_GET, (_event, id: string) => classRepository.get(id))

  safeHandle(IPC_CHANNELS.CLASSES_CREATE, (_event, data: CreateClassInput) => {
  ...
  safeHandle(IPC_CHANNELS.CLASSES_UPDATE, (_event, id: string, data: UpdateClassInput) => {
  ...
  safeHandle(IPC_CHANNELS.CLASSES_DELETE, (_event, id: string) => {
  ...
  safeHandle(IPC_CHANNELS.CLASSES_RESTORE, (_event, id: string) => {
  ...
  safeHandle(IPC_CHANNELS.CLASSES_GET_STAT_GROWTH, (_event, classId: string) => {
  ...
  safeHandle(IPC_CHANNELS.CLASSES_GET_STAT_GROWTH_FORMULAS, (_event, classId: string) =>
  ...
  safeHandle(IPC_CHANNELS.CLASSES_GET_DERIVED_STAT_OVERRIDES, (_event, classId: string) =>
  ...
  safeHandle(IPC_CHANNELS.CLASSES_GET_METADATA_FIELDS, (_event, classId: string) =>
  ...
  safeHandle(IPC_CHANNELS.CLASSES_GET_ABILITY_ASSIGNMENTS, (_event, classId: string) =>
  ...
  safeHandle(IPC_CHANNELS.CLASSES_GET_USED_BY, (_event, id: string) =>

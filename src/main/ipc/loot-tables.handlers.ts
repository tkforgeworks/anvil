...
export function registerLootTablesHandlers(): void {
  ...
  safeHandle(IPC_CHANNELS.LOOT_TABLES_GET, (_event, id: string) =>
    lootTableRepository.get(id),
  )

  safeHandle(IPC_CHANNELS.LOOT_TABLES_CREATE, (_event, data: CreateLootTableInput) => {
  ...
  safeHandle(IPC_CHANNELS.LOOT_TABLES_DELETE, (_event, id: string) => {
  ...
  safeHandle(IPC_CHANNELS.LOOT_TABLES_RESTORE, (_event, id: string) => {
  ...
  safeHandle(IPC_CHANNELS.LOOT_TABLES_GET_ENTRIES, (_event, id: string) =>
  ...
  safeHandle(IPC_CHANNELS.LOOT_TABLES_GET_USED_BY, (_event, id: string) =>

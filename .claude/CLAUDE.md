...
**Current status:** ANV-4 (Project Bootstrap & Application Shell), ANV-30 (domain repositories + IPC handlers), ANV-57 (repository integration test suite, 80 tests), ANV-6 (data model & schema foundation, with bug-fix child tickets ANV-58/59/60), and ANV-7 (custom fields system) implemented. Application shell compiles and runs with full IPC bridge, SQLite layer, React Router, MUI theme, and Zustand stores in place.
